...
- **validator_name** (<code>[str](#str)</code>) – The name of the validator to check

**Returns:**

- <code>[bool](#bool)</code> – Whether the validator requires a whole table to return appropriate results
