...
- [**success**](#metadata.sdk.data_quality.dataframes.validation_results.ValidationResult.success) (<code>[bool](#bool)</code>) – True if all tests passed
- [**total_tests**](#metadata.sdk.data_quality.dataframes.validation_results.ValidationResult.total_tests) (<code>[int](#int)</code>) – Total number of tests executed
- [**passed_tests**](#metadata.sdk.data_quality.dataframes.validation_results.ValidationResult.passed_tests) (<code>[int](#int)</code>) – Number of tests that passed
- [**failed_tests**](#metadata.sdk.data_quality.dataframes.validation_results.ValidationResult.failed_tests) (<code>[int](#int)</code>) – Number of tests that failed
- [**test_results**](#metadata.sdk.data_quality.dataframes.validation_results.ValidationResult.test_results) (<code>[List](#typing.List)\[[TestCaseResult](#metadata.generated.schema.tests.basic.TestCaseResult)\]</code>) – Individual test results
- [**execution_time_ms**](#metadata.sdk.data_quality.dataframes.validation_results.ValidationResult.execution_time_ms) (<code>[float](#float)</code>) – Total execution time in milliseconds
...
- <code>[List](#typing.List)\[[TestCaseResult](#metadata.generated.schema.tests.basic.TestCaseResult)\]</code> – List of test results where status is Failed or Aborted
...
- \***results** (<code>[ValidationResult](#metadata.sdk.data_quality.dataframes.validation_results.ValidationResult)</code>) – Variable number of ValidationResult objects to merge

**Returns:**

- <code>[ValidationResult](#metadata.sdk.data_quality.dataframes.validation_results.ValidationResult)</code> – A new ValidationResult with aggregated test case results

**Raises:**

- <code>[ValueError](#ValueError)</code> – If no results are provided to merge
...
- <code>[List](#typing.List)\[[TestCaseResult](#metadata.generated.schema.tests.basic.TestCaseResult)\]</code> – List of test results where status is Success
